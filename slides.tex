...
\begin{frame}{Case description}
	...
	\end{itemize}
	\only<2->{Task: Send taxonomy IDs of pathogens found and taxonomy ID of causative agent based on NGS data from nasal swab sample\\}
...
\begin{frame}{Is clinical metagenomics special?}
	\begin{tikzpicture}
